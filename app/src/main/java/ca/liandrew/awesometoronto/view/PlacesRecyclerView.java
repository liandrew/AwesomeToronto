 ...
 */
public class PlacesRecyclerView extends RecyclerView {
    ...
    public PlacesRecyclerView(Context context) {
        super(context);
    }

    public PlacesRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public PlacesRecyclerView(Context context, AttributeSet attrs, int defStyle) {
